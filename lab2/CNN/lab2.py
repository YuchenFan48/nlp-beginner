...
# vocab is global
def tokenize_dataset(dataset, vocab, glove_path='/Users/apple/Desktop/nlp-fdu/glove.6B.300d.txt'):
    split_dataset = []
    for data in dataset:
        item = {}
...
def pipeline(path, out_dir='/Users/apple/Desktop/nlp-fdu/lab2/CNN'):
...
if __name__ == "__main__":
    pipeline(
        '/Users/apple/Desktop/nlp-beginner/lab2/sentiment-analysis-on-movie-reviews/train.tsv')
